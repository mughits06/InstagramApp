...
class TambahPostActivity : AppCompatActivity() {
    ...
    private var storagePostPicturesRef: StorageReference? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        storagePostPicturesRef = FirebaseStorage.getInstance().reference.child("Post Picture")
    ...
    private fun uploadImage() {
        when{
            ...
            TextUtils.isEmpty(deskripsi_post.text.toString()) -> Toast.makeText(this, "Please Write Caption", Toast.LENGTH_SHORT).show()
                ...
                val fileRef = storagePostPicturesRef!!.child(System.currentTimeMillis().toString()+ "Posts")
