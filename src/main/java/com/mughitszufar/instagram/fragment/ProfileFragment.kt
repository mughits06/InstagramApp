...
import com.mughitszufar.instagram.AccountActivity
import com.mughitszufar.instagram.R
import com.mughitszufar.instagram.adapter.MyImagesAdapter
import com.mughitszufar.instagram.model.Post
import com.mughitszufar.instagram.model.User
...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        recyclerViewUploadImages = viewProfile.findViewById(R.id.recycler_upload_pictiamge)
        recyclerViewUploadImages?.setHasFixedSize(true)
        var linearLayoutManager = GridLayoutManager(context, 3)
        recyclerViewUploadImages?.layoutManager = linearLayoutManager

        postListGrid = ArrayList()
        myImagesAdapter = context?.let { MyImagesAdapter(it, postListGrid as ArrayList) }
                ...
                getButtonText == "Follow" -> {
                    ...
                    firebaseUser?.uid.let {
                        FirebaseDatabase.getInstance().reference
                            ...
                            .child("Following").child(it.toString()).setValue(true)
                    }
