package com.mughitszufar.instagram.adapter
...
import com.mughitszufar.instagram.CommentsActivity
import com.mughitszufar.instagram.MainActivity
...
class PostAdapter(private val mContext: Context, private val mPost: List<Post>): RecyclerView.Adapter<PostAdapter.ViewHolder>() {
    ...
    class ViewHolder(@NonNull itemView: View): RecyclerView.ViewHolder(itemView) {
        ...
        var description: TextView = itemView.findViewById(R.id.post_discription)
